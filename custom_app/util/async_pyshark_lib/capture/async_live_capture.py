...
from .async_capture import DEFAULT_PACKET_CAPTURE_SIZE, AsyncCapture
from packaging import version
from pyshark.tshark.tshark import get_tshark_interfaces, get_process_path

DEFAULT_LIVE_CAPTURE_TIMEOUT = 100
...
class AsyncLiveCapture(AsyncCapture):
    ...
    def __init__(self, capture_size=None, interface=None, bpf_filter=None, display_filter=None, only_summaries=False,
        ...
        """
        super(AsyncLiveCapture, self).__init__(capture_size=capture_size, display_filter=display_filter, only_summaries=only_summaries,
    ...
    def get_parameters(self, packet_count=None):
        ...
        params = super(AsyncLiveCapture, self).get_parameters(packet_count=packet_count)
        # Read from STDIN
        params += ["-i", "-"]
        return params
    ...
    async def _get_tshark_process(self, packet_count=None):
        ...
        tshark = await super(AsyncLiveCapture, self)._get_tshark_process(packet_count=packet_count, stdin=read)
        return tshark
